...
| 회의 # | 액션 | 분류 | 본 문서 # |
|--------|------|------|---------|
| 1 | 인보이스 발송 단위 오더 기준 합산 | 필수 | 1, 3 |
| 2 | 주문관리 화면에 인보이스 버튼 | 필수 | 1 |
| 3 | 주문관리 화면에 발송 상태 표시 | 필수 | 2 |
| 4 | 인보이스 발송 시 예약 일괄 처리 | 필수 | 3 |
| 5 | 운영자 수정 후 재발송 | 필수 | 6 |
| 6 | 상태값 정의 문서화 | 필수 | 4 |
| 7 | Confirmed 자동 트리거 검토 | 옵션 | 8 |
| 8 | 자동화 테스트 케이스 | 옵션 | 9 |
| 9 | 변경/취소 정책 정리 | 옵션 | 10 |
| 10 | 이니시스 PG 제약 확인 | 옵션 | 11 |
| 11 | 가격 증가 프로세스 정책 | 옵션 | 12 |
| 12 | Confirmed/Complete 화면 반영 | 필수 | 7 |
| 13 | Complete 자동화 검토 | 옵션 | 13 |
| 14 | 개발 이슈 등록 | 필수 | 이 문서 |
| 15 | 용어 통일 | 필수 | 5 |
