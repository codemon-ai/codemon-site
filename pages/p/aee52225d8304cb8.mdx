...
import { DomainMap } from '../../components/BlueMangoDocs'

## 2. 도메인 요구사항

<DomainMap domains={[
  { name: '상품관리', sub: 'Product Domain', accent: 'sky' },
  { name: '예약관리', sub: 'Booking Domain', accent: 'emerald' },
  { name: '결제/정산', sub: 'Payment · Settlement', accent: 'amber' },
  { name: '회원/인증', sub: 'User / Auth', accent: 'violet' },
  { name: '콘텐츠', sub: 'Content', accent: 'sky' },
  { name: '사이트운영', sub: 'SiteOps', accent: 'emerald' },
]} />
